...
public class State {
	...
	private List<String> ProList;// 标记函数的集合
	...
	public String toString() {
		...
		if (this.Successor != null) {
			...
			// succ.append(succ.substring(0, succ.length() - 1) +
			// "]"+"   Atoms:{");
			String tempString1 = succ.substring(0, succ.length() - 1)
					.toString() + "]   Atoms:{";
		...
		if (this.ProList != null) {
			...
			String tempString2 = succ1.substring(0, succ1.length() - 1)
					.toString() + "}";
